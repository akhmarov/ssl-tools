...
rem #
rem # Name: tls-cisco-wlc.cmd
rem #
rem # Date: October 2019
rem #
...
rem #        10. Repeat steps 1-9 on second controller from CLI
rem #
...
echo Archive: %WORK_DIR%\wa-arch.pem (password: %PEM_PASS%)
